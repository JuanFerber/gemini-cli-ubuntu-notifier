...
-   **Seguridad:** Scripts endurecidos con permisos `700` (`rwx------`), garantizando que solo el usuario propietario pueda ejecutarlos.
...
-   **`pulseaudio-utils` (paplay):** Instalado por defecto para la reproducción de alertas sonoras.
...
La extensión opera mediante interceptación de eventos de bajo nivel (`hooks.json`):
